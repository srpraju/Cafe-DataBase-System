...
exports.Select = (0, react_1.forwardRef)(function Select(_a, forwardedRef) {
    ...
    var _2 = (0, transition_1.useFixedPositioning)(__assign(__assign({ style: propListboxStyle, fixedTo: ref, nodeRef: nodeRef, anchor: anchor, onScroll: closeOnScroll ? hide : undefined, onResize: closeOnResize ? hide : undefined, transformOrigin: true, width: listboxWidth }, positionOptions), { onEntering: function () {
            var _a;
